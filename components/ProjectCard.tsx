...
export default function ProjectCard({ imgSrc, title, description, webLink, gitLink, blogLink }: { imgSrc: StaticImageData | string; title: string; description: string; webLink?: string; gitLink?: string; blogLink?: string }) {
    return (
