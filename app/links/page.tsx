...
export default function Page() {
    return (
        <section className="flex items-center flex-wrap gap-4 transition-all transition-[1000ms]">
            {/* github */}
            <Link
                href="https://github.com/BakirGracic"
                target="_blank"
                className="duration-[200ms] hover:bg-neutral-800  cursor-pointer border border-solid border-neutral-600 rounded-xl h-[120px] w-[120px] flex items-center justify-center"
            >
                <svg
