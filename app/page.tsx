    ...
    return (
        <section>
            ...
            <p className="mb-4">
                ...
                that is reliable, robust, fast, secure and that solves real-world problems and improves 
                people's lives white integrating it in business solutions. I'm currently working on a 
