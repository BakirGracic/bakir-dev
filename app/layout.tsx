...
export const metadata: Metadata = {
    ...
    description: "Discover Bakir's personal website & blog for insightful tips, helpful advice, fun & educational content on software development. Explore my top projects, achievements, certifications, and find links to connect",
    ...
    category: "technology, web development, blog, blogging, it, software, programming, coding, tutorials, projects, achievements, certifications, self-improvement",
};
