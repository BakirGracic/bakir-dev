...
| :---                 | :--- |
| **Server Type**      | [With Hetzner](https://console.hetzner.com), a CX33 will be sufficient for 10-32 players. We need at least 4 vCPU cores, 8GB RAM and 80GB disk space. If your region doesn't have CX33, choose the next closest plan with similar specs |
...
Published [here](https://community.hetzner.com/tutorials/game-server-cs2), contributed [here](https://github.com/hetzneronline/community-content/pull/1348)
