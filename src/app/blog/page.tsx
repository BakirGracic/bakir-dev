...
export const metadata = {
	...
	description:
		'Blogs are a medium to share knowledge and experiences and also to build them. Explore all the blogs Bakir wrote and to gain new perspectives.',
	alternates: {
			...
			<Script
				...
				dangerouslySetInnerHTML={{
					__html: JSON.stringify({
						...
						description:
							'A blog by Bakir Gracić about web development, technology, life, business, and more.',
